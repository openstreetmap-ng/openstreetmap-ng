...
_config: dict[str, dict] = {
    ...
    'amenity': {
        ...
        'library': 'amenity_library.16.webp',
        ...
        'post_box': 'amenity_post_box.16.webp',
        'post_office': 'amenity_post_office.16.webp',
        ...
        'telephone': 'amenity_telephone.16.webp',
    ...
    'leisure': {
        ...
        ElementType.way: {
            ...
            'swimming_pool': 'waterway_lake.webp',
    ...
    'shop': {
        ...
        'supermarket': 'shop_supermarket.webp',
    ...
    'water': {
        ElementType.way: {
            None: 'waterway_lake.webp',
        },
    },
    'waterway': {
        'dam': 'waterway_dam.webp',
        'weir': 'waterway_weir.webp',
        ElementType.way: {
            None: 'waterway_lake.webp',
        },
    },
...
for key_config in _config.values():
    for icon_or_type_config in key_config.values():
        ...
        for icon in icons:
            path = pathlib.Path('src/static/img/element/' + icon)
            if not path.is_file():
