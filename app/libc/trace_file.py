...
from app.libc.trace_file_processor.bzip2 import Bzip2FileProcessor
from app.libc.trace_file_processor.gzip import GzipFileProcessor
from app.libc.trace_file_processor.tar import TarFileProcessor
from app.libc.trace_file_processor.xml import XmlFileProcessor
from app.libc.trace_file_processor.zip import ZipFileProcessor
from app.libc.trace_file_processor.zstd import ZstdFileProcessor
...
class TraceFile:
    ...
    async def extract(buffer: bytes) -> Sequence[bytes]:
        ...
        for layer in range(1, 2 + 1):
            ...
            if not (processor := _trace_file_processors.get(content_type)):
