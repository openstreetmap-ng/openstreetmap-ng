...
Revision ID: 65f76d4886fc
Revises:
Create Date: 2024-12-15 21:41:27.323547+00:00
...
def downgrade() -> None:
    ...
    op.drop_index(
        'oauth2_token_hashed_idx', table_name='oauth2_token', postgresql_where=sa.text('token_hashed IS NOT NULL')
    )
    op.drop_index(
        'oauth2_token_authorized_user_app_idx',
        table_name='oauth2_token',
    ...
    op.drop_index('trace_visibility_user_id_idx', table_name='trace')
    op.drop_index('trace_tags_idx', table_name='trace', postgresql_using='gin')
    op.drop_table('trace')
    ...
    op.drop_index('note_comment_event_user_id_idx', table_name='note_comment')
    ...
    op.drop_table('mail')
    op.drop_table('issue')
    op.drop_index('diary_user_id_idx', table_name='diary')
    op.drop_index('diary_language_idx', table_name='diary')
    op.drop_table('diary')
    ...
    op.drop_index(
        'changeset_empty_idx', table_name='changeset', postgresql_where=sa.text('closed_at IS NOT NULL AND size = 0')
    )
