...
Revision ID: cc7ec7bfd888
Revises:
Create Date: 2024-02-26 21:33:01.858128+00:00
...
def upgrade() -> None:
    ...
    sa.Column('point', app.models.geometry_type.PointType(), nullable=False),
    ...
    sa.Column('home_point', app.models.geometry_type.PointType(), nullable=True),
    sa.Column('id', sa.BigInteger(), sa.Identity(always=False, minvalue=1), nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('statement_timestamp()'), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('bounds', app.models.geometry_type.PolygonType(), nullable=True),
    sa.Column('id', sa.BigInteger(), sa.Identity(always=False, minvalue=1), nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('statement_timestamp()'), nullable=False),
    ...
    sa.Column('point', app.models.geometry_type.PointType(), nullable=True),
    sa.Column('id', sa.BigInteger(), sa.Identity(always=False, minvalue=1), nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('statement_timestamp()'), nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('statement_timestamp()'), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    ...
    sa.Column('start_point', app.models.geometry_type.PointType(), nullable=False),
