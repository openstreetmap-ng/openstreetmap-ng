...
Revision ID: 7340c508dfd4
Revises:
Create Date: 2024-05-17 08:26:27.389779+00:00
...
def upgrade() -> None:
    ...
    op.create_index('element_current_idx', 'element', ['type', 'id', 'next_sequence_id'], unique=False, postgresql_include=('sequence_id',))
    ...
    sa.ForeignKeyConstraint(['sequence_id'], ['element.sequence_id'], ),
...
def downgrade() -> None:
    ...
    op.drop_index('element_current_idx', table_name='element', postgresql_include=('sequence_id',))
