...
COMPRESS_DYNAMIC_MIN_SIZE = 1 * _kb
COMPRESS_DYNAMIC_ZSTD_LEVEL = 3
COMPRESS_DYNAMIC_BROTLI_QUALITY = 3
COMPRESS_DYNAMIC_GZIP_LEVEL = 3
...
HTTP_BODY_MAX_SIZE = max(TRACE_FILE_UPLOAD_MAX_SIZE, XML_PARSE_MAX_SIZE) + 5 * _mb  # MAX + 5 MB
