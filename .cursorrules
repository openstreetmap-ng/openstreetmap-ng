...
This project is actively being developed, and breaking changes are acceptable.
...
- PostgreSQL 17 with PostGIS and TimescaleDB
...
- TypeScript (ES2023) with typed-query-selector, and MapLibre GL JS:
  - Avoid doing `as HTML...` casts: rely on typed-query-selector's smart type detection on querySelector/querySelectorAll:
